# -*- coding: utf-8 -*-
"""
Created on Thu Nov 17 14:46:49 2016
...
table1=extrusion(pos=path1,shape=shape,material=materials.wood,color=color.yellow)
table2=extrusion(pos=path2,shape=shape,material=materials.wood,color=color.blue)
table3=box(pos=(0,-1,0),size=(20,1,20),material=materials.wood)

taiqiu=sphere(pos=(7.5,0.5,0),radius=0.5,color=color.red,make_trail=True,material=materials.emissive)
taiqiu.tho=1
taiqiu.the=0
taiqiu.vtho=1
taiqiu.vthe=pi/12
